 ...
 * Use the {@link SingleItemFragment#newInstance} factory method to
...
public class SingleItemFragment extends Fragment {
    ...
    public static SingleItemFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View image = view.findViewById(R.id.arrowImage);

        image.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick(View v) {
                Navigation.findNavController(view).navigate(R.id.action_singleItemFragment_to_batmanFragment);
            }
        });
